# get_googleplay_appdata.py start
...
def get_googleplay_appdata(url):
    result = []
    ...
    # average rating
    rating = soup.find("div", class_="BHMmbe").attrs['aria-label']
    rating = remove_letters(rating)
    #print(rating)

    result.insert(1, rating)
    return result

# get_googleplay_appdata.py end
